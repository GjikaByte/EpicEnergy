...
@Repository
public interface IndirizzoSedeOperativaRepository extends JpaRepository<IndirizzoSedeOperativa, UUID> {
    @Query("SELECT i FROM IndirizzoSedeOperativa i WHERE i.via = :via AND i.civico = :civico AND i.localita= :localita")
